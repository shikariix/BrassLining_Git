...
////// Specular:
                ...
                float3 diffuseColor = ((node_6223.r*node_4557.rgb + node_6223.g*node_3362.rgb + node_6223.b*node_6729.rgb)*_AlbedoColour.rgb); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_4248 = float2(i.posWorld.r,i.posWorld.g);
                float4 node_6729 = tex2D(_AlbedoTexture,TRANSFORM_TEX(node_4248, _AlbedoTexture));
                float3 diffColor = ((node_6223.r*node_4557.rgb + node_6223.g*node_3362.rgb + node_6223.b*node_6729.rgb)*_AlbedoColour.rgb);
                float specularMonochrome;
                float3 specColor;
